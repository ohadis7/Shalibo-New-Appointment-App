...
$config['sess_match_ip'] = false; // Disabled to prevent session invalidation behind proxies/load balancers
$config['sess_time_to_update'] = 3600; // Regenerate session ID every hour instead of every 5 minutes
