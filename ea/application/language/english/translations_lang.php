...
$lang['about_app'] = 'About Shalibo Wellness';
...
$lang['about_app_info'] = 'Shalibo Wellness helps you manage your wellness appointments with ease. Schedule, reschedule, and manage all your wellness services in one place.';
$lang['current_version'] = 'Current Version';
$lang['support'] = 'Support';
$lang['about_app_support'] = 'If you encounter any problems when using Shalibo Wellness, please contact our support team at daniel@shalibowellness.com for assistance.';
...
$lang['about_app_license'] = 'Shalibo Wellness is built on open-source technology and is licensed under the GPLv3 license.';
...
$lang['ea_update_success'] = 'Your appointment system has been successfully updated.';
...
$lang['api_token_hint'] = 'Set a secret token in order to enable the token based authentication of the API.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API enable you to interact with all the appointment data via the HTTP protocol and the available API endpoints and create your own integrations.';
...
$lang['date_whitelist_enabled'] = 'Date Whitelist Mode';
$lang['date_whitelist_enabled_hint'] = 'Provider is unavailable by default and only available on explicitly defined exception dates. The regular working plan will be ignored.';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'This integration enables you to connect to an existing LDAP server and automatically import users into the system and let them SSO with their directory password (username must match).';
$lang['host'] = 'Host';
$lang['port'] = 'Port';
...
$lang['add_to_outlook_calendar'] = 'Add to Outlook Calendar';
$lang['display_add_to_outlook_calendar'] = 'Display "Add to Outlook Calendar" Button';
$lang['display_add_to_outlook_calendar_info'] = 'Show the "Add to Outlook Calendar" button on the booking confirmation page, allowing customers to easily add their appointment to their personal Outlook Calendar.';
...
$lang['service_date_restrictions'] = 'Date Restrictions';
$lang['service_date_restrictions_hint'] = 'Set specific date ranges when this service is available. The service will be hidden from the booking page outside these dates. Leave empty to always show the service.';
$lang['add_date_restriction'] = 'Add Date Range';
$lang['no_date_restrictions'] = 'No date restrictions — service is always available.';
$lang['date_restriction_start_after_end'] = 'Date restriction start date must be before or equal to the end date.';
