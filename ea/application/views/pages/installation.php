...
<head>
    ...
    <title>Installation | Shalibo</title>
...
<div class="container flex-grow-1">
    <div class="row">
        <div class="col-lg-9 offset-lg-1">
            ...
            <div>
                <h3>Welcome to the Shalibo installation page.</h3>

                <p class="text-break">
                    This page will help you set the main settings of your Shalibo installation. You will be able to
                    edit these settings and many more in the backend session of your system. Remember to use the
                    <strong class="text-primary">
                        <?= site_url('user/login') ?>
                    </strong> 
                    URL to connect to the backend section of Shalibo.
                </p>
            </div>
            ...
            <div class="mb-3">
                <h3>License</h3>
                Shalibo Wellness — Built on open-source technology (GPL-3.0). By using the
