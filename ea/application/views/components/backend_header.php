...
<nav id="header" class="navbar navbar-expand-md navbar-dark bg-primary p-0">
    <div id="header-logo" class="navbar-brand p-1 lh-1">
        <img src="<?= base_url(
            'assets/img/shalibo-logo.png',
        ) ?>" alt="Shalibo Logo" class="float-start me-2" style="width: 45px; height: 45px; border-radius: 50%;">
        <h6 class="mb-0 mt-1 fw-bold text-white" style="font-size: 16px; letter-spacing: 1px;">S H A L I B O</h6>
        <small class="d-block text-white-50" style="font-size: 11px;">Schedule your wellness journey</small>
    </div>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown text-center <?= $active . $hidden ?>" style="min-width: 100px;">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item" href="https://shalibowellness.com" target="_blank">
