...
<head>
    ...
    <title>
        <?= lang('appointment_cancelled_title') ?> | Shalibo
    </title>
    <style>
        /* -------------------------------------
            GLOBAL RESETS
                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        ...
                                        <!-- Logo linking to Shalibo Wellness -->
                                        <a href="https://shalibowellness.com" target="_blank">
                                            <img src="<?= base_url('assets/img/shalibo-logo.png') ?>" alt="Shalibo Wellness" style="display:block;max-width:67px;margin: auto auto 24px;">
                                        </a>
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td class="content-block powered-by">
                                <a href="https://shalibowellness.com" style="text-decoration: none;">
                                    Shalibo Wellness
                                </a>
                                |
